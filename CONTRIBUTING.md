...
3.  The pull request should work for Python 3.6, 3.7 and 3.8. Check <https://travis-ci.com/Vipul97/slr_parser/pull_requests> and make sure that the tests pass for all supported Python versions.
